# tools/regression_tool/lasso.py
...
def lasso_tool(data: Dict[str, Any], alpha: float = 1.0) -> str:
    """
    Lasso 회귀 분석을 수행합니다.
    ...
    try:
        ...
        # Lasso 회귀 모델 적합
        model = sm.OLS(y, X)
        lasso = model.fit_regularized(method='elastic_net', alpha=alpha, L1_wt=1)
        
        return lasso.summary().as_text()
    except Exception as e:
        return f"Lasso 회귀 분석 중 오류 발생: {str(e)}"
