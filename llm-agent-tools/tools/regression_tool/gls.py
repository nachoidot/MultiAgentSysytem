...
def gls_tool(data: Dict[str, Any], sigma: Any = None) -> str:
    """
    Generalized Least Squares (GLS) 회귀 분석을 수행합니다.
    
    Parameters:
        data (Dict[str, Any]): 분석할 데이터. 각 키는 변수 이름, 값은 리스트 형태의 데이터.
        sigma (Any, optional): 공분산 행렬. 기본값은 None.
